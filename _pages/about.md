...
Research interests
======
At the University of Essex, I am interested in developing new algorithms for diagnostic and treatment planning in healthcare. My work spans the continuum from machine learning and eXplainable AI foundations and theory to demonstrating novel applications in the real world to informing policy around safe ML adoption. My research interests and activities focus on machine learning and xAI for informed decision-making, non-stationary learning, brain-computer interfacing (BCI), EEG/MEG signal processing, and applying them in healthcare, businesses, and the environment. I work on the development of intelligent systems and practice my skills in the following programming languages: Python, Matlab, and R. 

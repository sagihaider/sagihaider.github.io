...
citation: 'Pandey, D S., Raza, H., and Bhattacharyya, S., Development of explainable AI-based predictive models for bubbling fluidised bed gasification process. <i>Fuel</i>.'
---

Highlights

* Seven types of regression models were developed for gas composition and gas yield.

* Explainable AI (XAI) method was used to explain individual predictions.

* The gradient boosting algorithm was the best amongst other regression-based models.

* Impact of input variables on target is explained with SHAP value.
